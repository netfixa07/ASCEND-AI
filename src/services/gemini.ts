...
export const generateDailyPlan = async (userData: any) => {
  ...
  try {
    ...
    return { tasks: [], aiFeedback: "Erro ao gerar plano. Tente novamente." };
  }
};
...
export const generate30DayChallenge = async (userData: any) => {
  ...
  try {
    ...
    console.error("Error parsing 30-day challenge JSON:", e);
    return { title: "Desafio Indisponível", description: "Erro ao gerar desafio.", tasks: [], category: "mental" };
  }
};
...
export const analyzeRootCause = async (userData: any, problem: string, history: any[] = []) => {
  ...
  try {
    ...
    return { analysis: "Erro na análise.", rootCause: "Indefinida", patterns: [], selfSabotage: false, immediateAction: "Tente novamente.", nextQuestion: "" };
  }
};
...
export const simulateFuture = async (userData: any) => {
  ...
  try {
    ...
    return { 
      negative: { "1year": "", "5years": "", "10years": "" }, 
      positive: { "1year": "", "5years": "", "10years": "" }, 
      warning: "Erro na simulação. Tente novamente." 
    };
  }
};
